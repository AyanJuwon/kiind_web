            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    customTextNormal(
                      "${translation.howMuchToDonate} ${_subscriptionPlans[_selectedSubscriptionPlan].toLowerCase()}?",
                      fontWeight: FontWeight.w600,
                      ...
                      children: [
                        Flexible(
                          child: customTextSmall(
                              AppLocalizations.of(context)!.wouldYouLikeToAdd25,
                              alignment: TextAlign.start,
                              fontWeight: FontWeight.w600,
                              fontSize: 12),
                        ),
